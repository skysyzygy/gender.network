    ...
    <>
      ...
      <button
        ...
        onClick={() => {
          ...
          change_textlocation("San Fransisco")
        }}
      >
        San Fransisco
      </button>
      ...
      {q.properties.map(post => (
        <Link href="/work/sample" key={post._id}>
          <div className="workCard" >
            ...
            {post.coverphoto && <Image src={post.coverphoto} placeholder="blur" blurDataURL="data:image/gif;base64,R0lGODlhAQABAPAAAOvis////yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="0" height="0" size="100vw" unoptimized style={{ width: '31.66vw', height: 'auto' }} /> }
