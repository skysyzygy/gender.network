...
const FullIndex = ({ properties, tagproperties }) => {
    console.log(properties);
    ...
    return (
      <div>
              ...
              {/* <SelectSearch options={tagproperties} value="sv" name="language" placeholder="Choose your language" onChange={values => setTagId(values.map(tag => tag._id))}/> */}
              <Select 
