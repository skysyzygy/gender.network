          ...
          >
            <div className="bubbles">
              <BubbleRegion
                title={record.title}
                image={record.image}
                indexslug={record.indexslug}
              />
              <BubbleTime
                title={timerecord.title}
                image={timerecord.image}
                indexslug={timerecord.indexslug}
              />
              <BubbleTopic
                title={topicrecord.title}
                image={topicrecord.image}
                indexslug={topicrecord.indexslug}
              />
              <BubbleType
                title={typerecord.title}
                image={typerecord.image}
                indexslug={typerecord.indexslug}
              />
            </div>
